      ...
      <div className="mx-4 md:mx-10 mt-10 rounded-2xl bg-gray-800">
        <div className="bg-gray-800 shadow px-4 py-4 md:p-8 rounded-2xl w-full">
          ...
          <div>
            ...
            <div className="mt-5 flex items-center justify-between max-w-[92%] mx-auto">
              <div className="h-2.5 bg-gray-300 rounded-full w-12"></div>
              <div className="h-2.5 bg-gray-300 rounded-full w-12"></div>
              <div className="h-2.5 bg-gray-300 rounded-full w-12"></div>
            </div>
            
            <div role="status" className="mt-5 p-4 space-y-4 max-w-full rounded animate-pulse md:p-6">
                <div className="flex justify-between items-center">
                    <div className="w-full max-w-[60%]">
                        <div className="h-2.5 bg-gray-300 rounded-full mb-2.5"></div>
